<?php
    ...
    $sql = "SELECT * FROM volei WHERE sala ='$turma' AND genero = '$genero'";   
    ...
    if ($inc < 11) {
     ...
     $sqlinsert = "INSERT INTO volei (id_jogador, sala, nome_jogador, numero_camisa, genero) VALUES ('', '$turma', '$nome', '$camisa', '$genero')";
