...
$sql = mysqli_query($link, "SELECT * FROM pontos_futebol WHERE turma = '$turma'");   
          ...
          <div class="aa-signin-area">
            <div class="aa-signin-form">
              <div class="aa-signin-form-title">
                <a class="aa-property-home">Cadastro de pontos das turmas - Modalidade: Futebol</a>
                <h4></h4>
              </div>
              <form class="contactform" method="POST" action="res_edit_futebolp.php">                                                 
