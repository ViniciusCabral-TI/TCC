          ...
          <div class="aa-signin-area">
            <div class="aa-signin-form">
              <div class="aa-signin-form-title">
                <a class="aa-property-home">Cadastro de jogadores - Modalidade: Handbol</a>
                <h4>Obs: Você só pode cadastrar até 12 jogadores, mas pode alterá-los no menu de edição</h4>
              </div>
              <form class="contactform" method="POST" action="res_handbol.php">                                                 
...
?>               
                ...
                <div class="aa-single-field">
                  <label for="" style="color: black">Gênero:<span class="required"></span></label><br>                   
