        ...
        <div class="col-md-12">
          <div class="aa-signin-area">
            <div class="aa-signin-form">
              ...
              <form class="contactform" action="res_aluno.php" method="POST">                                                 
                <div class="aa-single-field">
                  <label for="">RA:<span class="required"></span></label>
                  <input type="text" required="required" aria-required="false" value="" name="ra">
                </div>
                <div class="aa-single-field">
                ...
                <div class="aa-single-field">
                  ...
                  <input type="text" required="required" aria-required="false" value="" name="pai">
                </div>
                <div class="aa-single-field">
                  <label for="">Nome da mãe:<span class="required"></span></label>
                  <input type="text" required="required" aria-required="false" value="" name="mae">
                </div>
                <div class="aa-single-field">
                  <label for="">Município:<span class="required"></span></label>
                  <input type="text" required="required" aria-required="false" value="" name="municipio">
                </div>
                 <div class="aa-single-field">
                  <label for="">Estado:<span class="required"></span></label>
                  <input type="text" required="required" aria-required="false" value="" name="estado">
                </div>
                 <div class="aa-single-field">
                  <label for="">E-mail:<span class="required"></span></label>
                  <input type="text" required="required" aria-required="false" value="" name="email">
                </div>
                 <div class="aa-single-field">
                 ...
                 <div class="aa-single-field">
                  ...
                  <input type="text" required="required" aria-required="false" value="" name="cep">
                </div>
                 <div class="aa-single-field">
                  <label for="">Data de nascimento:<span class="required"></span></label>
                  <input type="date" required="required" aria-required="false" value="" name="nasc"
                  style=" width: 585px; height:39px">
                </div>
                <div class="aa-single-field">
                  <label for="">Turma:<span class="required"></span></label>
                  <select type="text" name="turma" required="required" style=" width: 585px; height:39px" >
<?php
