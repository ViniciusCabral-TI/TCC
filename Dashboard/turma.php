          ...
          <div class="aa-signin-area">
            <div class="aa-signin-form">
              <div class="aa-signin-form-title">
                <a class="aa-property-home">Cadastro de turmas:</a>
                <h4></h4>
              </div>
              <form class="contactform" action="res_turma.php" method="POST">                                                 
                ...
                <div class="aa-single-field">
                  <label for="">Número de alunos<span class="required"></span></label>
                  <input type="text" name="numa"> 
                </div>
                <div class="aa-single-field">
                  <label for="">Número da sala:<span class="required"></span></label>
                  <input type="text" name="nums"> 
                </div>
                <div class="aa-single-field">
                  <label for="">Professor conselheiro:<span class="required"></span></label>
